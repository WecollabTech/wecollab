    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'alcance' => 'required|in:Superadmin we collab,Admin we collab,Soporte we collab,Usuario we collab,Suscriptor SLC,Usuario Admin SLC,Usuario Premium SLC,Usuario Público,Prospecto',
